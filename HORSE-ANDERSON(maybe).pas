...
var f:array[-2..MER+3,-2..MER+3] of integer;
    way:array[1..MER*MER,1..2] of integer;
    pov:array[1..MER*MER] of integer;
    mas:array[1..MER*MER] of set of 1..8;
    x,y,n:integer;
...
begin 
  for var i:= -2 to MER+3 do
  begin
    for var j:= -2 to MER+3 do
    begin
      f[j,i]:=-1;
    end;
  end;
  
  for var i:= 1 to MER do
  begin
    for var j:= 1 to MER do
    begin
      f[j,i]:=0;
    end;
  end;
  ...
  while((n < don){or(bool)})and(n > 0)do
  begin
      //writeln('n = ',n);
      x:=way[n,1];
      y:=way[n,2];
